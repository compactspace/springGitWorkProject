...
public class LoginFormTeacherFilter  extends UsernamePasswordAuthenticationFilter {
	...
	@Autowired
	public TeacherAuthenticationProvider  fp;	
	
	
	public LoginFormTeacherFilter() {
		super();
		setFilterProcessesUrl("/teacher/logingo.do"); // 로그인 인증 필터에 로그인 검증 URL 등록
