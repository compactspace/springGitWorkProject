...
public class ArtWorkImagesDeleteResult {
	...
	// 🔹 기본 생성자
	public ArtWorkImagesDeleteResult() {
	}

	// 🔹 전체 필드를 받는 생성자
	public ArtWorkImagesDeleteResult(int statusCode, boolean bussinessStatus, String bussinessFaileReason) {
	...
	public ArtWorkImagesDeleteResult(int statusCode, boolean bussinessStatus) {
		this.statusCode = statusCode;
		this.bussinessStatus = bussinessStatus;
