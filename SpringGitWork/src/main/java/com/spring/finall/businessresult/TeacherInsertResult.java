...
public class TeacherInsertResult {
	...
	// 🔹 기본 생성자
	public TeacherInsertResult() {
	}

	// 🔹 전체 필드를 받는 생성자
	public TeacherInsertResult(int statusCode, boolean bussinessStatus, String bussinessStatusReason) {
	...
	public TeacherInsertResult(int statusCode, boolean bussinessStatus) {
		this.statusCode = statusCode;
		this.bussinessStatus = bussinessStatus;
