...
public interface ReserveService {
	...
	boolean dupulicateCheckForReservePayment(String merchantUid);

	boolean checkClientPriceEqualsToRecentUpdatedPrice(String merchantUid,Integer recentPrice);

	boolean updateDraftReserveStatusTo(String merchantUid);
